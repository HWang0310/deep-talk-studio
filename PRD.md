...
长期产品要支持“我不知道今天讲什么”。V0.2 仍只保留 Topic Discovery 的模块位置，不实现自动选题。未来候选话题应综合：近期社会、商业、科技、网络与公共事件，创作者关注方向，信息新鲜度，观点冲突度，证据可获得性和频道匹配度。
...
V0.2 的成功不是“AI 写得像一个知名博主”，而是：编辑能快速看清什么已确认、谁在说什么、每条证据如何关联主张、核查是否真的做了新搜索、哪些高风险内容被拦截，以及下一步该从哪个问题切入。
