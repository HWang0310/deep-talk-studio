...
- V0.5.1 与 V0.6.1 已正式验收；第一轮真实 E2E Material + Motion 与 Preview Hardening 均已通过。当前只等待 canonical lineage Review；不要自行开始 Audio Alignment + Edit Bridge，也不要扩展假主播、TTS、最终剪辑、字幕、BGM、标题封面或发布。
