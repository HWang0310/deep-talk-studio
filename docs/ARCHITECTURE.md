...
No V2 schema, migration, renderer, candidate pack, `edit-map/2`, or production default exists yet. Target diagrams are architecture direction, not proof of code.
