...
- [Multi-Asset Implementation Plan](plans/2026-08-28-multi-asset-implementation-plan.md) — accepted implementation sequencing; not an implementation or release claim. Its next gate is separate Phase 0 work.
