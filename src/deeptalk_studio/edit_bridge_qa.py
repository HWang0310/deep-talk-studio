...
class EditBridgeQAInputs:
 root_valid:bool;transcript_valid:bool;alignment_valid:bool;placements:List[dict];preview_used_placement_ids:List[str];audio_presentation_valid:bool
...
def run_edit_bridge_qa(inputs):
 ...
 check("root","root_artifacts_revalidated",inputs.root_valid,"invalid_root_binding")
 check("transcript","mapping_chunk_transcript_rederived",inputs.transcript_valid,"invalid_transcript_chain")
 check("alignment","normalization_status_risk_rederived",inputs.alignment_valid,"alignment_false_ready")
 ...
 check("preview","clean_aroll_audio_presentation",inputs.audio_presentation_valid,"preview_audio_presentation_mismatch")
