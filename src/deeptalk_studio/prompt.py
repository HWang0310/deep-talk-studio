...
候选要说明为什么是现在、核心张力、可继续研究的问题、风险和五项评分理由。不要输出总分、排序、推荐标签、播放量、搜索指数或任何无法追溯的热度数字。Creator 的公开标题或主题如可见，只能作为辅助讨论信号；绝不抓取稿件、字幕或独特表达，也不能把创作者观点当事实证据。匿名传言、纯情绪、未经证实的严重指控或高风险且没有可靠资料基础的题材应明确降级。输出必须符合给定 JSON Schema。"""
